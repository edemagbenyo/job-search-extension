...
const getRelativePath = (filePath) => (
  ...
  const fileDir = path__default.dirname(filePath);
  const relDir = path__default.relative(process.cwd(), fileDir);
